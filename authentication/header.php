...
<html class="no-js">
    ...
    <?php
    $user = $_GET['username'];
    echo "<title> Welcome to Dashboard, $user </title> "
    ?>
        
		<meta name="description" content="TRA FILE MANAGER">
		<meta name="keywords" content="TRA FILE MANAGER">
		<meta name="author" content="ABDULRAHMAN HEMED OTHMAN">
		<meta charset="UTF-8">
        <!-- Bootstrap -->
