...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $reason_for_defect=$_POST['reason_for_defect'];
        ...
        if (isset($batchNumber)) {
            $sql_update = "UPDATE batch SET status = 'Completed' WHERE batchNumber = '$batchNumber'";
            ...
            if ($conn->query($sql_update) === TRUE) {
                    $_SESSION['msg'] = "L2 verification successful";
            } else {
...
<?php
    ...
    <i class="fas fa-exclamation-triangle mr-2"></i> Defective Files
      ...
      onmouseover="this.style.backgroundColor='#604536'" onmouseout="this.style.backgroundColor='black'">Send back to weeding room</button>
</div>
   </div>
